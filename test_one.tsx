                ...
                <div className='py-16 md:py-24 flex flex-col gap-12 md:gap-16'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-between gap-10 lg:gap-0'>
                        ...
                        <div className='flex-1 flex flex-col gap-2'>
                            ...
                            <Link href="mailto:bookings@samanmaharjan.com.np" className='geist text-[#D3D3D3] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[57px] font-medium break-all hover:text-[#F13333] transition-colors duration-300 ease-in-out'>
                                bookings@samanmaharjan.com.np
                            </Link>
                        </div>

                        {/* LINKS */}
                        <div className='flex-1 flex justify-start lg:justify-end gap-10 sm:gap-20 lg:gap-40 flex-wrap'>
                            ...
                            <div className='sm:col-span-7 overflow-hidden'>
                                ...
                                >
                                    {["SAMAN MAHARJAN", "MAGICIAN", "MENTALIST"].map((text, idx) => (
                                        <span
                                            key={idx}
                                            className="big-shoulders mx-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[107px] font-bold text-[#F13333] whitespace-nowrap"
                                        >
                                            {text}
                                        </span>
                                    ))}
